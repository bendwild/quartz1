...
description: "- suddenly got the news that I might still be eligible for a BAEF scholarship fucking crazy, quickly scrambled to get my remaining applications in order for american universities\r
  ...
  - chill internship of pediatrics, my mentor understands and supports my situation

  \r- finally some sun ughhh"
publish: false
---
```dataview
TABLE description
FROM #daily-notes
WHERE created >= date(2025-04-01) AND created <= date(2025-04-31)
SORT created ASC
``` 
