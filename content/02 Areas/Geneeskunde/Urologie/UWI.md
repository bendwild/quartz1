...
## Types
-> aspecifieke UWI (diverse [[content/02 Areas/Geneeskunde/Klinisch redeneren/Kiemen|kiemen]])
...
-> opstijgende infecties (>99%)
	- kolonisatie door [[content/02 Areas/Geneeskunde/Klinisch redeneren/Kiemen|kiemen]] van buitenaf
	- **[[E. Coli]]** (70-95%), **S. Saprophyticus** (5-10%), Klebsiella, enterococcen (>> gram-negatieven)
-> gecompliceerd
	- slecht functionerend afvloeisysteem

# Differentiaal diagnostisch schema

![[Pasted image 20241222142549.png]]
...
Recidiverend? Pijn in rug of onderbuik? aanwijzingen voor [[SOI's]]? recent onderzoek blaas of prostaat?

> [!important] Bij zuigelingen (<3m) met koorts / ouderen met aspecifieke klachten -> ALTIJD urine controleren

> [!important] Hematurie kan passen binnen bv cystitis klachten 

> [!ATTENTION] Eig is dipstick (en zelfs urinesediment) niet zo sens/spec
> -> blijf verder denken en sta stil over de waarde van je onderzoek

> [!ATTENTION] PSA en rectaal toucher geen grote meerwaarde

# Aanpak

## Aspecifieke acute UWI
### 1. Asymptomatische bacteriurie
-> enkel te behandelen bij zwangere vrouwen

### 2. Acute bacteriële cystitis bij de vrouw
...
> [!ATTENTION] Hematurie met cystitisklachten kan passen in het beeld, verandert het beleid niet

#### Onderzoek
- urinekweek bij DM

#### Behandeling 
-> zelflimiterend, spontane genezing binnen 1-2w
- niet-medicamenteuze adviezen
	- veel water drinken
	- blaas leegplassen
	- mictie niet uitstellen
	- plassen na sex
- afwachtend beleid + pijnstilling
	- met ev uitgesteld voorschrift

-> bij **verhoogd risico op gecompliceerd verloop** ([[zwangerschap]], bij mannen, [[diabetes mellitus]],  immunocompromitatie, anatomische afwijkingen aan nieren en urinewegen, neurologische blaasstoornissen, verblijfscatheter)
- kortdurende AB-kuur van 3-5d
	-> klachten zullen sneller verdwijnen + minder kans op recidieven
	- Nitrofurantoïne (eerste keus, echter toenemende resistentie)
		- CAVE [[Zwangerschap]] (niet tijdens laatste weken -> risico op hemolytische [[anemie]])
		- niet doeltreffend bij [[chronische nierinsufficiëntie]]
		- [[Anticonceptie]] minder effectief
		- inname bij voedsel verbetert resorptie & vermindert GI-bijwerkingen
	- Fosfomycine (alternatief)
	- Quinolonen (voor ernstige infecties)
		- CAVE [[Zwangerschap]]
	- Co-trimoxazole (veel resistentie)


> [!ATTENTION] Risico's bij acute cystitis bij vrouw
> -> indien geen structurele afwijkingen of co-morbiditeit -> **geen** risico op acute [[pyelonefritis]]
> -> wel verhoogd risico bij afwijkingen urinewegen, [[diabetes mellitus]], immuungecompromitteerd...

> [!ATTENTION] Plaats van trimethoprim
> Trimethoprim is enkel een eerste keuze bij cystitis bij **hoogbejaarden en patiënten met nierinsufficiëntie** omdat nitrofurantoïne gecontra-indiceerd is bij patiënten met nierinsufficiëntie. Wanneer gebruikt bij recidiverende cystitis moet de behandeling eventueel bijgesteld worden op geleide van antibiogram ([[E. Coli]] hoge resistentie).

### 3. Acute bacteriële cysto(-[[prostatitis]]) bij de man
...
#### Behandeling
- Ongecompliceerde cystitis -> eigenlijk geen indicatie voor [[antibiotica]]
- Indien prostaat meedoet -> penetrerende AB gedurende **min 14d**, indien nodig na herevaluatie tot **28d**
	- [[Levofloxacine]]
	- [[Ciprofloxacine]]

-> alternatieven zijn [[amoxicilline-clavulaanzuur]] en co-trimoxazole

> [!ATTENTION] Bij mannen met UWI doet prostaat eigenlijk theoretisch altijd mee
> -> standaard behandelen of PSA? - meningen zijn verdeeld

> [!Important] Vermijd prostaatmassage en sondage bij begin v/e [[prostatitis]] -> kan aanleiding geven tot bacteriëmie

### 4. Acute bacteriële cystitis bij het kind
#Pediatrie 
...
#### Diagnose
##### Urinecollectie
- urinezakje kleven in de uro-genitale zone
- clean catch methode
	- voiding stimulation en urine opvangen in steriel recipient (paravertebrale massage, koude vloeistof)
	- vooral bij zuigelingen <3m
- suprapubische punctie

##### Interpretatie
![[Pasted image 20250125154620.png]]![[Pasted image 20250125154630.png]]

**Urinecultuur** (na 24-48u wachten)
![[Pasted image 20250125154655.png]]

> [!important] Geen evidentie voor routine afname inflammatoire parameters

#### Behandeling
- [[Nitrofurantoine]]
- Alternatief: cefuroxim axetil
