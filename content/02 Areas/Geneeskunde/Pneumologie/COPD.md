...
Inflammatie bij COPD zorgt voor *longbeschadiging* -> emfyseem

> [!important] =/= [[Astma]] -> enkel inflammatie thv grote & kleine luchtwegen (longen zelf zijn normaal)
...
2. **[[Dyspneu]]** agv **LW obstructie, hyperinflatie en verhoogde ademarbeid**
	o Hyperinflatie: bij COPD pten is het moeilijker en duurt het langer om alles uit te ademen, als je inspanning doet wordt je ademhalingsfrequentie opgedreven en dus ga je onvoldoende lang kunnen uitademen om lucht weer volledig uit te ademen = **toename residueel volume** = **hyperinflatie**
...
3. **Respiratoire insufficiëntie**
	o Type I: ↓O2 ondanks normale ventilatie (PCO2 =/↓) -> geef O2, oxygenatie
	o Type II: ↑CO2 met O2 =/↓ -> ventileren, nl beademen
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hyperinflatie staat centraal**<br>- Tonvormige thorax<br>- Piepende ronchi en grove crepitaties<br>- Verminderd vesiculair ademgeruis<br>- Doffe harttonen<br>- Gebruik secundaire ademhalingsspieren | **Respiratoire insufficiëntie staat centraal**<br>- Hypoxie, cyanose<br>- rechter hart decompensatie → stuwing v. Jugularis, [[oedeem]] van de onderste ledematen, hepatomegalie<br> |
...
- radiologie
- CAT/mMRC score
	- [COPD assessment test (CAT)](https://www.mdcalc.com/calc/10161/copd-assessment-test-cat)
		- impact van COPD op dagelijks functioneren
	- [modified Medical Research Council dyspnea score (mMRC)](https://www.mdcalc.com/calc/4006/mmrc-modified-medical-research-council-dyspnea-scale)
		- subjectieve gewaarwording kortademigheid
	-> worden ook gebruikt voor de GOLD-criteria
...
### Obv spirometrie
-> meten na bronchodilatatie (4 puffs snelwerkende)
...
2. Systemische *[[corticosteroïden]]*: methylprednisolone 32 mg 1 co daags gedurende 5 d
    ...
    - evalueer na 1-3d
3. zo nodig *[[antibiotica]]*: bv amoxiclav of bij peni-[[Allergie]] [[moxifloxacine]]
...
4. Zo nodig: *zuurstof*
	- streefdoel O2 saturatie > 88-92%
    - titreren gezien risico op carbonarcose bij ernstig COPD
- NIPPV (non-invasive positive pressure ventilation) in severe COPD exacerbations and type 2 respiratory insufficiency

> [!important] Opletten met O2 toediening bij COPD
...
> [!danger]  -> want enkel LAMA of LABA levensgevaarlijk indien ook asthma  
...
1. Acute exacerbatie
	...
	3. kan infectieus zijn ([[S. Pneumoniae]], [[H. Influenza]], [[M. Catarhhalis]])
2. Acute respiratoire insufficiëntie
	1. aPO2 < 60 mmHg = partiële respiratoire insufficiëntie
...
# Prognose
**[BODE index](https://www.mdcalc.com/calc/3916/bode-index-copd-survival)** -> predicts survival in COPD patients
- **B** MI
- **O** bstruction (FEV₁% of predicted)
- **D** yspnea (mMRC scale)
- **E** xercise capacity