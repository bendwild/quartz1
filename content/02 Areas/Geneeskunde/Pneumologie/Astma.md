...
o **Atopie** = aanleg hebben om allergisch of buitengewoon overgevoelig te reageren op normale, niet levensbedreigende stoffen of omstandigheden
...
o **Socio-economische status** (~roken)

o **Familiegrootte**: meer infecties van broers of zussen -> relatieve bescherming tegen astma

o **Voeding**: [[Borstvoeding]] is beschermend tegen [[Allergie]] (min 6m-1j)

o **Farmaca** (aspirine, [[NSAID]])
- Kunnen bij volwassenen astma-opstoot uitlokken tot zelfs status asmaticus

> [!ATTENTION] APA syndroom 
> - Astma
> - Polyposis nasi
> - Aspirine [[allergie]]
> -> wanneer zij aspirine of [[NSAID]] innemen doen ze acute astma-aanval die zeer ernstig kan zijn
...
= herhaalde episodes (>3x) van hoesten, wheezing en kortademigheid, variabel in tijd en intensiteit
= anamnestisch-klinische benadering centraal

**Symptomen:**
- hoesten
- kortademigheid bij inspanning, in rust of 's nachts (door endogeen cortisol)
...
|              | Licht    | Matig    | Ernstig                  | Levensbedreigend               |
| ------------ | -------- | -------- | ------------------------ | ------------------------------ |
| **Posture**      | Normaal  | Zitten   | Tripod                   |                                |
| **Ausculatatie** | Wheezing | Wheezing | Verminderde ademgeluiden | Sterk verminderde ademgeluiden |
| **Tachycardie**  | +        | ++       | +120/130                 | Bradycardie                    |
| **Speech**       | Normaal  | ZInnen   | Woorden                  | Onmogelijk                     |
| **Bewustzijn**   | Normaal  | Normaal  | Agitatie                 | Verminderd                     |

**Identificeer risicopatiënten!**
- spoedconsult/hospitalisatie wegens opstoot in het afgelopen jaar
- recent gebruik van orale corticoïden
- zonder (adequate) onderhoudsbehandeling met inhalatiesteroïden
- veelvuldig reliever gebruik
- psychosociale problemen
- voedselallergieën
- co-morbiditeiten

> [!DANGER] Wees er op bedacht dat astma in se een levensbedreigende aandoening is, zelfs 'mild' astma kan een ernstige astma aanval uitlokken -> vrl bij de risicopatiënten

**Differentiaal diagnose**
- [[pneumonie]]
- [[pneumothorax]]
- corpus alienum (lage drempel voor bronchoscopie)
- [[COPD]]
- ...
## Diagnose astma
Indien vermoeden astma obv van kliniek of score-systemen (bv mAPI bij kinderen - [Modified Astma Predictive Index](https://www.mdcalc.com/calc/3382/modified-asthma-predictive-index-mapi))
-> aantonen obstructief [[Longlijden]]
	- spirometrie met Tiffenau index (FEV1/FVC) <0.75
...
- max 1/week symptoom overdag & geen nachtelijke symptomen
- geen functionele beperking in dagelijkse activiteiten
- normale piekstroom meting
- minder dan 1 asthma opstoot per jaar (-> dus **geen opstoten**)
...
> [!important] Hand-mond coördinatie moeilijk <12j
...
### ASTMA AANVAL
-> acute exacerbatie
- repetitieve toediening van snelwerkende β2-agonisten 
	- 4-10 puffs, elke 2-3u
	- aerosol/puffer gelijkwaardig, echter puffer werkt wel sneller dan aerosol
- PO corticoïden (prednisolone)
- weinig aanvullend voordeel van antihistaminica, mucolytica, respiratoire fysiotherapie, inhalatie corticoïden
- ev snel werkende anticholinergica, wordt meer gebruikt bij [[COPD]]
- NIV kan worden ingezet echter risicovol (dynamische hyperinflatie & invasief)
	- vermijd intubatie tenzij echt nodig, grootste moment van mortaliteit
- ?adrenaline -> twijfel dd anaphylaxie

## Patiënteneducatie

Achtergrondinformatie:

Astma is een **chronische ontsteking van de luchtwegen**, die ontstaat door het **overmatig reageren van de luchtwegen op bepaalde prikkels**, specifieke prikkels zoals allergenen (huisstofmijt, dieren, pollen,…) en niet specifieke prikkels zoals irriterende dampen en koude lucht. Dit leidt tot een **vernauwing van de luchtwegen**, waardoor de symptomen optreden. Er is vooral ’s nachts en in de vroege morgen last. De ernst van de symptomen is wisselend en er zijn klachtenvrije periodes tussen de aanvallen. **Het is een reversibele aandoening.**
...
**Controle**
- Bij verandering medicatie: **na 1 à 2 weken controle** -> dan is reeds effect te verwachten
