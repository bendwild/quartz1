...
- Vetmetabolisme
    Synthese van [[Cholesterol pathway]]
    - Via acetyl coA
    Triglyceriden
    - Opstapeling
    - Synthese
    ...
    - **Non-alcoholic fatty liver disease**
	    ...
	    - actief leverlijden
	    - hoger risico op evolutie naar fibrose en [[Levercirrose]]
	    ...
	    - leverbiopsie
			...
			**!!Natuurlijke evolutie NASH- burnt-out NASH (alle morfologische tekens verdwijnen, lever wordt identiek aan post-alcoholische cirrose)- kan evolueren naar fibrose en [[Levercirrose]]!!**
...
- Bescherming & klaring
    ...
    `Bij inflammatie` -> toename cellen  
...
- Fe opstapeling
    ...
    **Lever voornaamste orgaan waar ijzer opgestapeld wordt. Andere stapelplaatsen zijn pancreas, endocriene klieren en hart.**
    ...
    - bij laattijdige diagnose
        ...
        - hoger risico op ontwikkeling van primair leverca
