...
- stimuleert intestinale absorptie calcium
...
> [!ATTENTION] Mg is essentieel voor PTH werking, activatie en functie van vitamine D & de indirecte regulatie van Ca en P

# Hyperparathyroïdie

> [!EXAMPLE] Mnemonic **RHINOS** (etiologie hyperPTH)
> - **R** enal insufficiency (frequentste oorzaak van secundair/tertiair hyperPTH)
...
2. Symptomatisch (>>langzaam progressief, sneller indien symptomatisch + jonge patiënt)
	**Verschijnselen hypercalcemie:**
    ...
    - cardiaal (toegenomen contractiliteit, verkorte systole) -> [[ECG]]
    - [[Dehydratatie]] en nierinsufficiëntie door polyurie en mentale sufheid
    
    **Lange termijn:**
    - (recidiverende) [[urolithiasis]]
    - skeletafwijkingen ([[Osteoporose]] meest frequent)
    - nefrocalcinose en nierinsufficiëntie

> [!ATTENTION] Remember: **stones, bones, abdominal groans and psychic moans**
...
> -> pseudo-hypercalciëmie obv hyperalbuminemie
...
1. Conservatieve of afwachtende houding (**indien mild/weinig progressief**)
    ...
    - opsporen [[Urolithiasis]] op geleide van kliniek
...
> [!ATTENTION] Behandeling hypercalciëmie
> 1. Hydratatie!
> 2. Oorzakelijk
> 3. Botresorptieremmers (bifosfonaten, denosumab)
> 4. Calcimimetica (indien verhoogd PTH)
...
- andere vormen (intestinale [[malabsorptie]], vit-D-deficiëntie, **lisdiuretica**)  
