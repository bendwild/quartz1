...
# Short term goals 
- start MSc in Global Health at UCSF
	- how to make the most of this year?
		- build network
		- ask around about potential opportunities or experiences working in global health/tropical medicine
- studentenjob in de zomer
		- **zomerarts opgroeien**
		- ~~GHI Antwerpen?~~
		- ~~TOR Utrecht~~
- apply for summer schools on global health or DEI
- capstone project?
	- WHO internship?
	- tropisch instituut?
- HAIOTO traject
	- werk een proposal uit (refugee health x climate change x NCD's?)
	- stuur berichtje naar Sarah Derveeuw, Peter Decat, Geraldine Deberdt, Laure-Ann Quenon ter evaluatie van een eerste versie van de proposal?
	- meld je aan voor het HAIO traject in maart
	- [[Starten als arts]]
	- RSTMH grant 2025
...
- AIOS traject OIGT
	...
	- contacteer ex OIGT artsen om hun ervaringen te horen
		- ![[image-424.png]]
	- hou de vacature openingen in de gaten
- Opnieuw Fayat beurs proberen? en dan tropical medicine in Nagasaki bv?
- kcgh electives doen

# Long term goals
- maybe some opportunities can be found in San Fransisco?
- Appliceren voor think thank / beleidsvormingsgroep
	- vrijdaggroep
	- jonge academie
